        ...
        <div class="tab-content">
            <div class="col-md-6">
                <div class="main-card mb-3 card">
                    <div class="card-body"><h5 class="card-title">Modification d'un fournisseur</h5>
                        <form class="" action="<?php echo base_url();?>Admin/Administrateur/modifierFournisseur" method="post">
                            <?php foreach ($listesFournisseurs as $four):?>
                                <input type="hidden" name="idFour" value="<?php echo $four->id_four;?>">
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Nom</label>
                                    <input name="nom" id="nom" placeholder="Saisissez le nom du fournisseur" type="text" class="form-control" value="<?php echo $four->nom_four;?>">
                                </div>

                                <div class="position-relative form-group">
                                    <label for="examplePassword" class="">Adresse</label>
                                    <input name="adresse" id="adresse" placeholder="Saisissez l'adresse du fournisseur" type="text" class="form-control" value="<?php echo $four->adresse_four;?>">
                                </div>

                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Téléphone</label>
                                    <input name="tele" id="tele" placeholder="Saisissez le numéro du fournisseur " type="number" class="form-control" value="<?php echo $four->telephone_four;?>">
                                </div>

                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Email</label>
                                    <input name="email" id="email" placeholder="Saisissez le mail du fournisseur" type="email" class="form-control" value="<?php echo $four->adr_email;?>">
                                </div>
