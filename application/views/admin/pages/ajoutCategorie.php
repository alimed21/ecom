            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Ajout d'une catégorie</h5>
                            <form action="<?php echo base_url();?>Admin/Administrateur/ajoutCategorie" method="post" enctype="multipart/form-data">
                                <div class="position-relative row form-group">
                                    <label for="exampleEmail" class="col-sm-2 col-form-label">Catégorie</label>
                                    <div class="col-sm-10"><input name="cate" id="cate" placeholder="Saisi d'une catégorie" type="text" class="form-control"></div>
