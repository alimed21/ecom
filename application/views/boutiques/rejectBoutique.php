...
<div class="wrapper">
    ...
    <div class="gradient">
        <div class="container">
            ...
            <h2 class="mb-0 mt-4 text-white">Inscription rejecter.</h2>
            <p class="mt-2 text-white">L'inscription de votre boutique a été rejecter veuillez vous assurez que vous utilisez bien une adresse électronique qui vous appartient.</p>
            <p>merci d'avoir utilisé notre solution.</p>
            <a class="btn bg-white text-primary d-inline-flex align-items-center" href="<?= base_url();?>Boutiques/inscriptionBoutique">Inscription</a>
        </div>
        <div class="box">
