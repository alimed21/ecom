                    ...
                    <div class="col-md-10">
                        <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                            <div class="card-body">
                                ...
                                <h2 class="mb-2 text-center">Confirmation</h2>
                                <p class="text-center">Veuillez confirmer le code sécret que vous avez reçu.</p>
                                <?php if (isset($erreur_message)):?>
                                    <div class="alert alert-danger" role="alert">
                                        <?php echo $erreur_message; ?>
                                    </div>
                                <?php endif; ?>
                                <form action="<?php echo base_url();?>Boutiques/codeOtp" method="post">
                                    <div class="row">
                                        <input type="hidden" name="email" value="<?php echo $email;?>">
                                        <input type="hidden" name="essaie" value="<?php echo $essaie;?>">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="username" class="form-label">Code secret</label>
                                                <input type="number" class="form-control" id="code_otp" name="code_otp" placeholder="Veuillez saisir le code secret">
                                                <span class="infoMessage"><?php echo form_error('code_otp'); ?></span>
                                            </div>
                                        </div>
