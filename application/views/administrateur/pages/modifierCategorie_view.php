<div>
        ...
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if($detailCategorie != false):?>
                        <form class="form-horizontal" action="<?php echo base_url();?>Admin/Administrateur/modificationCategorie" method="post">
                            <?php foreach($detailCategorie as $liste):?>
                                <input type="hidden" name="id" value="<?php echo $liste->id_cate;?>">
                                <div class="form-group row">
                                    <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Catégorie :</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="cate" name="cate" value="<?php echo $liste->cate;?>">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">Liste des catégories ajouter</h4>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table id="datatable" class="table table-striped" data-toggle="data-table">
                        ...
                        <?php if($listesCategories != false):?>
                            <?php foreach ($listesCategories as $liste): ?>
                                <tr>
                                    <td><?= $liste->cate;?></td>
                                    <td><?= $liste->login_admin;?></td>
                                    <td><?= $liste->date_add;?></td>
                                    <td>
                                        <a href="<?php echo base_url();?>Admin/Administrateur/modifierCategorie/<?php echo $liste->id_cate;?>">
                                            <i class="icon">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url();?>Admin/Administrateur/suppressionCategorie/<?php echo $liste->id_cate;?>" onclick="return confirm('Etes-vous sûr de vouloir supprimer cette catégorie?');">
                                            <i class="icon">
