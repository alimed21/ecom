        ...
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url();?>Admin/Administrateur/ajoutSsCategorie" method="post">
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Sous-catégorie :</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sscate" name="sscate" placeholder="Libeller du sous-catégorie">
