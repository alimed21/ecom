        ...
        <div class="col-sm-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url();?>Admin/Administrateur/ajoutCategorie" method="post">
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="email1">Catégorie :</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="cate" name="cate" placeholder="Libeller de la catégorie">
