                    ...
                    <div class="col-md-10">
                        <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                            <div class="card-body">
                                ...
                                <p class="text-center">Veuillez créer votre compte pour votre boutique <?php echo $nom;?>.</p>
                                <?php if (isset($error_message)):?>
                                    <div class="alert alert-danger" role="alert">
                                        <?php echo $error_message; ?>
                                    </div>
                                <?php endif; ?>
                                <form action="<?php echo base_url();?>Inscription/VerifyForm" method="post">
                                    <div class="row">
                                        <input type="hidden" name="codeBoutique" value="<?php echo $codeBoutique;?>">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="Cnfmotdepasse" class="form-label">Confirmation</label>
